...
var App = {
    ...
    initVm: function(tplData) {
        ...
        var registerInfoVm = avalon.define({
            ...
            finish: function(evt) {
                ...
                // //console.log("grade", $el.find('.grade').find("option:selected").text());
                // setTimeout(function() {
                //     console.log("on..");
            ...
            sumbitHandle: function() {
                ...
                new Ajax({
                    url: 'http://i.yanxiu.com/user/train/register/saveInfo.tc',
                    type: 'post',
                    data: data,
        ...
        this.$el.find('.combo-input').blur(function() {
            //console.log('2222');
            // if (!!registerInfoVm.drapdownToggle) {
            //     clearTimeout(registerInfoVm.dropdownTimer);
            //     registerInfoVm.drapdownToggle = false;
            // }
            setTimeout(function() {
    ...
    getareaList: function(v_areacode, callback) {
        ...
        //var areaList = [];
        new Ajax({
            url: 'http://i.yanxiu.com/user/train/register/getAreaList.tc?areacode=' + areacode,
            type: 'get',
            data: {},
            success: function(data) {
                var code = data.code || 0;
    ...
    getschoolList: function(v_areacode, callback) {
        ...
        var schoolList = [];
        new Ajax({
            url: 'http://i.yanxiu.com/user/train/register/getSchoolList.tc?areacode=' + areacode,
            type: 'get',
            data: {},
            success: function(data) {
                var code = data.code || 0;
